<div class="three wide column">
	<div class="ui vertical menu fixed" style="top: 4rem;left: 1rem;width: 16.50% !important">
		...
		<div class="ui dropdown item">
			...
			<div class="left menu">
				<a href="{base_url}index.php/home/data_tamatan" class="item"><i class="student icon"></i> Data Tamatan</a>
				<a href="{base_url}index.php/home/tbh_tamatan" class="item"><i class="add user icon"></i> Tambah Tamatan</a>
				<a href="{base_url}index.php/home/perbaruan_tamatan" class="item"><i class="announcement icon"></i> Perbaruan Tamatan &nbsp;<span class="ui red label">12</span></a>
			</div>
		</div>
